            ...
            <div>
                ...
                <form onSubmit={this.add.bind(this)} ref={this.form.setRef}>
                    ...
                    <Row className="mb-1">
                        <Col md="6">
                            <div className="mdc-text-field" style={{ width: "100%" }}>
                                ...
                                <label htmlFor="consumers-add-description" className="mdc-floating-label">Description</label>
                                <div className="mdc-line-ripple"></div>
                            </div>
                        </Col>
                    </Row>
                    ...
                    <div className="mt-5">
                        ...
                        <Ripple onClick={this.add.bind(this)} className={"ml-4 mdc-button mdc-button--unelevated" + (ConsumersModel.adding ? " disabled" : "")} style={{ textTransform: "none" }}>Add</Ripple>
                    </div>
                </form>
            </div>
        )
