...
Depending on the environment `<HOST>` has to be replaced by `http://iot.pcxd.me`, `http://localhost` or wherever you deploy iotplatform. Every gateway supports ingesting either single JSON objects
